...
- Reusable workflows shipped in `.github/workflows/` (`review.yml`, `autofix.yml`): users wire with 5 lines — `uses: Dharmik-Lathiya/CodeSentinel_AI/.github/workflows/review.yml@v0.11.0` + `secrets: inherit`. Ready-to-copy templates in `examples/`
