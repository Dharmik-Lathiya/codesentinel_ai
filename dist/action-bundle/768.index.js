...
__webpack_require__.d(__webpack_exports__, {
  AI_PROMPT: () => (/* binding */ AI_PROMPT),
  APIConnectionError: () => (/* binding */ sdk_APIConnectionError),
  APIConnectionTimeoutError: () => (/* binding */ sdk_APIConnectionTimeoutError),
  APIError: () => (/* binding */ sdk_APIError),
  APIUserAbortError: () => (/* binding */ sdk_APIUserAbortError),
  Anthropic: () => (/* binding */ Anthropic),
  AnthropicError: () => (/* binding */ sdk_AnthropicError),
  AuthenticationError: () => (/* binding */ sdk_AuthenticationError),
  BadRequestError: () => (/* binding */ sdk_BadRequestError),
  ConflictError: () => (/* binding */ sdk_ConflictError),
  HUMAN_PROMPT: () => (/* binding */ HUMAN_PROMPT),
  InternalServerError: () => (/* binding */ sdk_InternalServerError),
  NotFoundError: () => (/* binding */ sdk_NotFoundError),
  PermissionDeniedError: () => (/* binding */ sdk_PermissionDeniedError),
  RateLimitError: () => (/* binding */ sdk_RateLimitError),
  UnprocessableEntityError: () => (/* binding */ sdk_UnprocessableEntityError),
  "default": () => (/* binding */ sdk),
  fileFromPath: () => (/* binding */ sdk_fileFromPath),
  toFile: () => (/* binding */ sdk_toFile)
});
...
const VERSION = '0.27.3'; // x-release-please-version
...
var lib = __webpack_require__(6705);
// EXTERNAL MODULE: ./node_modules/formdata-node/lib/esm/index.js + 3 modules
var esm = __webpack_require__(5165);
// EXTERNAL MODULE: ./node_modules/agentkeepalive/index.js
var agentkeepalive = __webpack_require__(3873);
// EXTERNAL MODULE: ./node_modules/abort-controller/dist/abort-controller.js
var abort_controller = __webpack_require__(7413);
// EXTERNAL MODULE: external "node:fs"
var external_node_fs_ = __webpack_require__(3024);
// EXTERNAL MODULE: ./node_modules/form-data-encoder/lib/esm/index.js + 8 modules
var lib_esm = __webpack_require__(6598);
...
async function node_runtime_fileFromPath(path, ...args) {
    ...
    const { fileFromPath: _fileFromPath } = await __webpack_require__.e(/* import() */ 33).then(__webpack_require__.bind(__webpack_require__, 2033));
...
(function (PromptCaching) {
    PromptCaching.Messages = messages_Messages;
