...
function searchConfigPaths(cwd) {
  ...
  if (process.env.CODESENTINEL_CONFIG) {
    const p = (0, import_node_path.resolve)(dir, process.env.CODESENTINEL_CONFIG);
    if ((0, import_node_fs.existsSync)(p)) return p;
  }
  for (const name of SEARCH_PATHS) {
    const p = (0, import_node_path.resolve)(dir, name);
    if ((0, import_node_fs.existsSync)(p)) return p;
  }
  return null;
}
...
var userConfigSchema = import_zod.z.object({
  mode: import_zod.z.enum(["review", "fix", "audit", "score", "testgen", "chat", "gate", "describe", "improve"]).optional(),
  max_iterations: import_zod.z.number().int().positive().optional(),
  enable_auto_fix: import_zod.z.boolean().optional(),
  enable_scoring: import_zod.z.boolean().optional(),
  enable_test_generation: import_zod.z.boolean().optional(),
  include_positive_feedback: import_zod.z.boolean().optional(),
  dry_run: import_zod.z.boolean().optional(),
  custom_prompt_paths: import_zod.z.record(import_zod.z.string()).optional(),
  project_context: import_zod.z.string().optional(),
  default_model: import_zod.z.object({ provider: import_zod.z.string(), model: import_zod.z.string() }).optional(),
  models: import_zod.z.record(import_zod.z.string(), import_zod.z.any()).optional(),
  test_runner: import_zod.z.enum(["jest", "vitest"]).optional(),
  include: import_zod.z.array(import_zod.z.string()).optional(),
  exclude: import_zod.z.array(import_zod.z.string()).optional(),
  output: import_zod.z.record(import_zod.z.any()).optional(),
  enable_cache: import_zod.z.boolean().optional(),
  cache_dir: import_zod.z.string().optional(),
  plugins: import_zod.z.array(import_zod.z.string()).optional(),
  analyzer: import_zod.z.object({
    enableEnhancedAnalysis: import_zod.z.boolean().optional(),
    severityAdjustment: import_zod.z.object({
      highRiskPatterns: import_zod.z.array(import_zod.z.string()).optional(),
      lowRiskPatterns: import_zod.z.array(import_zod.z.string()).optional(),
      historyBasedAdjustment: import_zod.z.boolean().optional(),
      changeFrequencyMultiplier: import_zod.z.number().optional()
    }).optional(),
    confidenceThresholds: import_zod.z.object({
      security: import_zod.z.number().min(0).max(1).optional(),
      bug: import_zod.z.number().min(0).max(1).optional(),
      performance: import_zod.z.number().min(0).max(1).optional(),
      smell: import_zod.z.number().min(0).max(1).optional(),
      style: import_zod.z.number().min(0).max(1).optional()
    }).optional(),
    customRules: import_zod.z.array(
      import_zod.z.object({
        id: import_zod.z.string(),
        name: import_zod.z.string(),
        pattern: import_zod.z.string(),
        severity: import_zod.z.enum(["info", "low", "medium", "high", "critical"]),
        category: import_zod.z.enum(["bug", "security", "performance", "smell", "style", "praise"]),
        comment: import_zod.z.string(),
        suggestion: import_zod.z.string().optional(),
        filePatterns: import_zod.z.array(import_zod.z.string()).optional(),
        confidence: import_zod.z.number().min(0).max(1).optional()
      })
    ).optional(),
    progressiveAnalysis: import_zod.z.object({
      quickScanRules: import_zod.z.array(import_zod.z.string()).optional(),
      standardScanRules: import_zod.z.array(import_zod.z.string()).optional(),
      deepScanRules: import_zod.z.array(import_zod.z.string()).optional(),
      autoEscalate: import_zod.z.boolean().optional(),
      escalationThreshold: import_zod.z.number().optional()
    }).optional(),
    multiFileAnalysis: import_zod.z.object({
      maxConcurrentFiles: import_zod.z.number().optional(),
      analyzeDependencies: import_zod.z.boolean().optional(),
      analyzeImports: import_zod.z.boolean().optional(),
      analyzePatterns: import_zod.z.boolean().optional(),
      fileGroupPatterns: import_zod.z.array(import_zod.z.string()).optional()
    }).optional()
  }).optional(),
  gate: import_zod.z.object({
    minScore: import_zod.z.number().min(0).max(100).optional(),
    maxCritical: import_zod.z.number().min(0).optional(),
    maxHigh: import_zod.z.number().min(0).optional(),
    blockOnSecurity: import_zod.z.boolean().optional(),
    blockOnBugs: import_zod.z.boolean().optional()
  }).optional(),
  secretPatterns: import_zod.z.array(import_zod.z.object({
    id: import_zod.z.string(),
    name: import_zod.z.string(),
  ...
  dismissalsFile: import_zod.z.string().optional(),
  dashboard: import_zod.z.object({
    port: import_zod.z.number().optional(),
    dataDir: import_zod.z.string().optional()
  }).optional(),
  jsonl_output: import_zod.z.boolean().optional(),
  linters: import_zod.z.object({
    enabled: import_zod.z.boolean().optional(),
    tools: import_zod.z.array(import_zod.z.string()).optional(),
    args: import_zod.z.record(import_zod.z.array(import_zod.z.string())).optional()
  }).optional(),
  enableSecretScanner: import_zod.z.boolean().optional(),
  securityBlendStrategy: import_zod.z.enum(["min", "avg", "static-only"]).optional(),
  learning: import_zod.z.object({
    enabled: import_zod.z.boolean().optional(),
    dbPath: import_zod.z.string().optional(),
    metaReview: import_zod.z.boolean().optional(),
    patternDiscovery: import_zod.z.boolean().optional(),
    metaReviewInterval: import_zod.z.number().optional()
  }).optional(),
  mcp: import_zod.z.object({
    enabled: import_zod.z.boolean().optional(),
    servers: import_zod.z.array(import_zod.z.any()).optional()
  }).optional(),
  batch: import_zod.z.object({
    enabled: import_zod.z.boolean().optional(),
    batchSize: import_zod.z.number().optional(),
    maxFilesPerBatch: import_zod.z.number().optional(),
    maxLinesPerFile: import_zod.z.number().optional()
  }).optional()
}).passthrough();
function loadConfig(opts = {}) {
  ...
  if (configPath) {
    const path = (0, import_node_path2.resolve)(configPath);
...
var DEFAULT_PROMPT_DIR = (0, import_node_path3.resolve)(__dirname, "..", "..", "prompts");
var PromptRegistry = class {
  ...
  load(name) {
    ...
    const candidates = [
      custom && (0, import_node_path3.resolve)(custom),
      (0, import_node_path3.join)(this.promptDir, `${name}.md`)
    ].filter(Boolean);
...
function walk(root) {
  ...
  while (stack.length) {
    ...
    for (const entry of entries) {
      ...
      const full = (0, import_node_path4.join)(dir, entry);
      let st;
      try {
      ...
      else out.push((0, import_node_path4.relative)(root, full));
    }
  }
  return out;
}
function readIgnoreFile(root) {
  const ignorePath = (0, import_node_path4.resolve)(root, ".codesentinelignore");
  if (!(0, import_node_fs4.existsSync)(ignorePath)) return [];
  try {
    const content = (0, import_node_fs4.readFileSync)(ignorePath, "utf8");
...
function ensureDir(path) {
  if (!(0, import_node_fs4.existsSync)(path)) (0, import_node_fs4.mkdirSync)(path, { recursive: true });
}
...
var AnalysisCache = class {
  ...
  generateKey(filePath, content, configHash) {
    const contentHash = (0, import_node_crypto.createHash)("sha256").update(content).digest("hex").slice(0, 16);
  ...
  loadFromDisk(key) {
    try {
      const filePath = (0, import_node_path5.join)(this.cacheDir, `${key}.json`);
  ...
  saveToDisk(key, entry) {
    try {
      const filePath = (0, import_node_path5.join)(this.cacheDir, `${key}.json`);
      (0, import_node_fs5.writeFileSync)(filePath, JSON.stringify(entry), "utf8");
    } catch {
    }
  }
  /**
  ...
  loadMemoryCache() {
    try {
      ...
      for (const file of files) {
        ...
        const filePath = (0, import_node_path5.join)(this.cacheDir, file);
        const content = (0, import_node_fs5.readFileSync)(filePath, "utf8");
  ...
  evictOldEntries() {
    ...
    for (const entry of toRemove) {
      ...
      try {
        const filePath = (0, import_node_path5.join)(this.cacheDir, `${entry.key}.json`);
...
function generateConfigHash(config) {
  ...
  return (0, import_node_crypto.createHash)("sha256").update(JSON.stringify(sortedConfig)).digest("hex").slice(0, 16);
}
...
var ProgressiveAnalyzer = class {
  ...
  analyzeImportsExports(files) {
    ...
    for (const file of files) {
      ...
      const exports2 = this.extractExports(file.content);
      totalImports += importPaths.length;
      totalExports += exports2.length;
...
var FileCache = class {
  ...
  key(namespace, payload) {
    const hash = (0, import_node_crypto2.createHash)("sha256").update(JSON.stringify(payload)).digest("hex").slice(0, 32);
  ...
  get(namespace, payload) {
    const path = (0, import_node_path6.join)(this.dir, this.key(namespace, payload));
    ...
    try {
      ...
      (0, import_node_fs6.writeFileSync)(path, (0, import_node_fs6.readFileSync)(path, "utf8"), "utf8");
  ...
  set(namespace, payload, value) {
    const path = (0, import_node_path6.join)(this.dir, this.key(namespace, payload));
    try {
      (0, import_node_fs6.writeFileSync)(path, JSON.stringify(value), "utf8");
      this.evictIfNeeded();
    } catch {
    }
  }
  ...
  evictIfNeeded() {
    try {
      const files = (0, import_node_fs6.readdirSync)(this.dir).filter((f) => f.endsWith(".json")).map((f) => {
        const fp = (0, import_node_path6.join)(this.dir, f);
        const stat = (0, import_node_fs6.statSync)(fp);
      ...
      for (const f of toRemove) {
        try {
          (0, import_node_fs6.unlinkSync)(f.path);
        } catch {
        }
      }
    } catch {
...
var TestGenerator = class {
  ...
  async generateForFile(root, file) {
    ...
    const outPath = parsed.test_file_path ? (0, import_node_path7.resolve)(root, parsed.test_file_path) : targetPath;
    ensureDir((0, import_node_path7.dirname)(outPath));
    (0, import_node_fs7.writeFileSync)(outPath, parsed.content, "utf8");
    return { file: file.path, testFilePath: (0, import_node_path7.relative)(root, outPath), content: parsed.content };
  }
  /** Determine the conventional test file path for a source file. */
  testPathFor(root, srcPath) {
    const abs = (0, import_node_path7.resolve)(root, srcPath);
    const dir = (0, import_node_path7.dirname)(abs);
    const ext = srcPath.match(/\.([^.]+)$/)?.[1] ?? "ts";
    const base = srcPath.replace(/\.[^.]+$/, "");
    if (this.config.test_runner === "jest") {
      return (0, import_node_path7.join)(dir, "__tests__", (base.split("/").pop() ?? "index") + `.test.${ext}`);
    }
    return (0, import_node_path7.join)(root, base + `.test.${ext}`);
  }
};
...
var DismissalManager = class {
  ...
  dismissals = [];
  load() {
    if ((0, import_node_fs8.existsSync)(this.filePath)) {
      try {
        const raw = (0, import_node_fs8.readFileSync)(this.filePath, "utf8");
  ...
  save() {
    const dir = (0, import_node_path8.dirname)(this.filePath);
    if (!(0, import_node_fs8.existsSync)(dir)) (0, import_node_fs8.mkdirSync)(dir, { recursive: true });
    (0, import_node_fs8.writeFileSync)(this.filePath, JSON.stringify(this.dismissals, null, 2), "utf8");
  }
...
var DashboardServer = class {
  ...
  data = { runs: [] };
  dataPath() {
    return (0, import_node_path9.resolve)(this.dataDir, "dashboard.json");
  }
  loadData() {
    const p = this.dataPath();
    if ((0, import_node_fs9.existsSync)(p)) {
      try {
        this.data = JSON.parse((0, import_node_fs9.readFileSync)(p, "utf8"));
      } catch {
        this.data = { runs: [] };
      }
    }
  ...
  saveData() {
    const p = this.dataPath();
    const dir = (0, import_node_path9.resolve)(this.dataDir);
    if (!(0, import_node_fs9.existsSync)(dir)) (0, import_node_fs9.mkdirSync)(dir, { recursive: true });
    (0, import_node_fs9.writeFileSync)(p, JSON.stringify(this.data, null, 2), "utf8");
  }
  recordRun(run) {
...
function parseExports(path, content) {
  ...
  lines.forEach((line, idx) => {
    ...
    if (match) {
      exports2.push({ name: match[1], file: path, line: idx + 1 });
    }
    const namedMatch = line.match(namedExportRe);
    if (namedMatch) {
      for (const n of namedMatch[1].split(",")) {
        const name = n.trim().split(/\s+as\s+/).pop()?.trim();
        if (name) exports2.push({ name, file: path, line: idx + 1 });
      }
    }
  });
  return exports2;
...
var eslint = {
  name: "eslint",
  detect(root) {
    return (0, import_node_fs10.existsSync)((0, import_node_path10.resolve)(root, "node_modules", ".bin", "eslint"));
  },
  run(root, extraArgs) {
    try {
...
var biome = {
  name: "biome",
  detect(root) {
    return (0, import_node_fs10.existsSync)((0, import_node_path10.resolve)(root, "node_modules", ".bin", "biome"));
  },
  run(root, extraArgs) {
    try {
      const out = (0, import_node_child_process2.execSync)(
...
var pylint = {
  ...
  detect(root) {
    try {
      (0, import_node_child_process2.execSync)("which pylint", { stdio: "ignore" });
      return true;
    } catch {
      return false;
    }
...
var gitleaks = {
  ...
  detect() {
    try {
      (0, import_node_child_process3.execSync)("which gitleaks", { stdio: "ignore" });
      return true;
    } catch {
      return false;
    }
  ...
  run(root) {
    try {
      const out = (0, import_node_child_process3.execSync)(
...
var trufflehog = {
  ...
  detect() {
    try {
      (0, import_node_child_process3.execSync)("which trufflehog", { stdio: "ignore" });
      return true;
    } catch {
      return false;
    }
  ...
  async connect(cfg) {
    try {
      ...
      if (cfg.type === "local" && cfg.command) {
        ...
        transport = new import_sse.SSEClientTransport(new URL(cfg.url));
      } else {
...
var SeveritySchema = import_zod2.z.enum(["info", "low", "medium", "high", "critical"]);
var MAX_SUMMARY_LENGTH = 2e3;
var MAX_TITLE_LENGTH = 200;
var MAX_DESCRIPTION_LENGTH = 1e3;
var MAX_MESSAGE_LENGTH = 1e3;
var MAX_SUGGESTION_LENGTH = 2e3;
var SummaryEntrySchema = import_zod2.z.object({
  type: import_zod2.z.literal("summary"),
  summary: import_zod2.z.string().min(1).max(MAX_SUMMARY_LENGTH)
});
var VerdictEntrySchema = import_zod2.z.object({
  type: import_zod2.z.literal("verdict"),
  verdict: import_zod2.z.enum(["approved", "changes_requested", "comment"])
});
var StrengthEntrySchema = import_zod2.z.object({
  type: import_zod2.z.literal("strength"),
  title: import_zod2.z.string().min(1).max(MAX_TITLE_LENGTH),
  description: import_zod2.z.string().max(MAX_DESCRIPTION_LENGTH).optional()
});
var IssueEntrySchema = import_zod2.z.object({
  type: import_zod2.z.literal("issue"),
  severity: SeveritySchema,
  category: import_zod2.z.enum(["bug", "security", "performance", "smell", "style"]),
  file: import_zod2.z.string().min(1),
  line: import_zod2.z.number().int().positive().nullable().optional(),
  message: import_zod2.z.string().min(1).max(MAX_MESSAGE_LENGTH),
  suggestion: import_zod2.z.string().max(MAX_SUGGESTION_LENGTH).optional()
});
var ReviewEntrySchema = import_zod2.z.discriminatedUnion("type", [
  SummaryEntrySchema,
  VerdictEntrySchema,
  StrengthEntrySchema,
  IssueEntrySchema
...
var Engine = class _Engine {
  constructor(config, secrets, root = process.cwd(), aiOverride) {
    ...
    this.cache = new FileCache((0, import_node_path11.resolve)(root, config.cache_dir));
    this.plugins = new PluginManager({ config, logger });
    this.eventBus = new EventBus();
    this.analyzer = new StaticAnalyzer(
      config.analyzer,
      (0, import_node_path11.resolve)(root, config.cache_dir, "analysis")
    );
    this.dismissals = new DismissalManager((0, import_node_path11.resolve)(root, config.dismissalsFile));
    this.dashboard = new DashboardServer(config.dashboard.port, (0, import_node_path11.resolve)(root, config.dashboard.dataDir));
  ...
  async collectedFiles() {
    ...
    return rels.map((path) => ({
      path,
      content: readText((0, import_node_path11.resolve)(this.root, path))
    }));
  }
  // ---------------------------------------------------------------------------
...
Suggestion: ${f.suggestion}` : ""}`,
  ...
  async applyFix(finding, iteration) {
    const filePath = (0, import_node_path11.resolve)(this.root, finding.file);
    ...
    if (parsed.fixed && this.config.enable_auto_fix && !this.config.dry_run) {
      ...
      (0, import_node_fs11.writeFileSync)(filePath, fixedContent, "utf8");
  ...
  async batchApplyFix(filePath, findings, iteration) {
    const absPath = (0, import_node_path11.resolve)(this.root, filePath);
...
- Output: Markdown explanation, then \`\`\`json { "fixed": bool, "explanation": "...", "hunks": [...] } \`\`\``;
    ...
    if (parsed.fixed && this.config.enable_auto_fix && !this.config.dry_run) {
      ...
      const fixedContent = applyHunks(content, parsed.hunks ?? []);
      (0, import_node_fs11.writeFileSync)(absPath, fixedContent, "utf8");
      verified = await this.runVerification();
...
_\u2026 and ${hidden} earlier attempts omitted._`);
  ...
  writeReportFile(report) {
    ensureDir((0, import_node_path11.resolve)(this.root, this.config.output.reportDir));
    const name = report.mode === "score" && report.score ? "score.json" : `codesentinel-${report.mode}.json`;
    const path = (0, import_node_path11.resolve)(this.root, this.config.output.reportDir, name);
    (0, import_node_fs11.writeFileSync)(path, JSON.stringify(report, null, 2), "utf8");
    logger.info(`Wrote report: ${path}`);
    if (this.config.output.writeHtmlReport) {
      const htmlName = name.replace(".json", ".html");
      const htmlPath = (0, import_node_path11.resolve)(this.root, this.config.output.reportDir, htmlName);
      (0, import_node_fs11.writeFileSync)(htmlPath, renderHtmlReport(report), "utf8");
...
async function publishOutputs(report, secrets, autoMerge = false) {
  ...
  if (summaryPath) {
    (0, import_node_fs12.writeFileSync)(summaryPath, renderSummary(report), "utf8");
  }
