...
export function loadConfig(opts = {}) {
    ...
    const final = mergeConfig(fromFile, opts.overrides ?? {});
...
export function configFromInputs(inputs) {
    const out = {};
    if (inputs.mode)
    ...
    if (inputs.project_context)
        out.project_context = inputs.project_context;
    ...
    if (inputs.mcp_enabled)
        out.mcp = { enabled: inputs.mcp_enabled === "true", servers: [] };
