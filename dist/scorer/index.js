...
export class Scorer {
    ...
    scoreStatic(files, findings) {
        ...
        return this.finalize({
            ...
            rationale: "Baseline score derived from static heuristics (security findings, " +
    ...
    finalize(b) {
        ...
        const overall = clamp(readability * WEIGHTS.readability +
    ...
    coverageMetric(files) {
        ...
        for (const f of sourceFiles) {
            ...
            if ([...testPaths].some((t) => t.startsWith(base)))
                covered++;
        }
