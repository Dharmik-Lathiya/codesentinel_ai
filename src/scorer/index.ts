...
/** Readability bonus multiplier applied to comment density. */
const COMMENT_RATIO_BONUS = 20;
/** Floor for per-file readability scores. */
...
export class Scorer {
  ...
  private readabilityMetric(
    ...
    for (const { content } of files) {
      ...
      const score = 100 - longLines * 2 + commentRatio * COMMENT_RATIO_BONUS;
