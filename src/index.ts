...
'          CODESENTINEL_GITHUB_TOKEN: ${{ secrets.CODESENTINEL_GITHUB_TOKEN }}',
  ...
  "            git config --global http.https://github.com/.extraheader \"AUTHORIZATION: basic \\$(printf 'x-access-token:%s' \"\\$GIT_PUSH_TOKEN\" | base64)\" 2>&1",
  ...
  "              git push origin HEAD:${{ github.ref_name }} 2>&1 || { echo \"❌ Push failed after recovery\"; echo \"::endgroup::\"; exit 1; }",
