...
"            }",
  ...
  "        with:",
  "          script: |",
  "    if: github.event_name === 'issue_comment' && github.event.action === 'created' && (github.event.comment.author_association === 'OWNER' || github.event.comment.author_association === 'MEMBER' || github.event.comment.author_association === 'COLLABORATOR')",
  "",
...
"            core.setOutput('question', question);",
  ...
  "          INPUT_ASK: ${{ steps.cmd.outputs.question }}",
  "        with:",
  "          mode: ${{ steps.cmd.outputs.mode }}",
  "          use_opencode_cli: \"false\"",
