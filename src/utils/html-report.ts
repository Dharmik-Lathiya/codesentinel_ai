...
const SCORE_RING_BORDER_RADIUS_PERCENT = 50;
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .score-ring { width: 80px; height: 80px; border-radius: ${SCORE_RING_BORDER_RADIUS_PERCENT}%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; font-weight: ${BOLD_FONT_WEIGHT}; color: #fff; }
