...
const RETRYABLE_STATUS_RATE_LIMIT = 429;
const RETRYABLE_STATUS_SERVICE_UNAVAILABLE = 503;
const RETRYABLE_STATUS_BAD_GATEWAY = 502;
const RETRYABLE_STATUS_CODES = new Set([
  RETRYABLE_STATUS_RATE_LIMIT,
  RETRYABLE_STATUS_SERVICE_UNAVAILABLE,
  RETRYABLE_STATUS_BAD_GATEWAY,
]);
